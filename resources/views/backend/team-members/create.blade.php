            ...
            <form action="{{ route('backend.team-members.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-12">
                        ...
                        @include('backend.partials.form.input', ['name' => 'designation', 'label' => 'Designation', 'required' => true])
                        @include('backend.partials.form.input', ['name' => 'qualification_l1', 'label' => 'Qualification Info (Line 1)'])
                        @include('backend.partials.form.input', ['name' => 'qualification_l2', 'label' => 'Qualification Info (Line 2)'])
