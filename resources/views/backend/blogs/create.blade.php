...
@section('page-title', 'Create Research & Publication')
            ...
            <form action="{{ route('backend.blogs.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-12">
                        ...
                        @include('backend.partials.form.lsf.lsf-textarea', ['name' => 'body', 'lang_options' => ['en', 'bn'], 'labels' => ['Blog Content', 'কন্টেন্ট'], 'row' => 15, 'wysiwyg' => true, 'required' => true])
                        ...
                        @include('backend.partials.form.file', ['name' => 'pdf_file', 'label' => 'PDF File', 'attributes' => ['accept' => '.pdf']])
